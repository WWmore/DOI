...
class GeolabMesh(MeshPlotManager):
    ...
    vertex_color_select = Trait(QColor(122, 163, 230), width=20, label='vertex_color', editor=ColorEditor(mapped=False)) ##Hui update

    vertex_color_select_ = QColor(255, 255, 255)  ##Hui add

    edge_color_select = Trait(QColor(122, 163, 230), width=20, label='edge_color', editor=ColorEditor(mapped=False)) ##Hui update
    
    edge_color_select_ = QColor(255, 255, 255)  ##Hui add
    
    face_color_select = Trait(QColor(122, 163, 230), width=20, label='face_color', editor=ColorEditor(mapped=False)) ##Hui update
